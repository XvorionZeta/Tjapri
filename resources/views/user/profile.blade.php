                ...
                <div class="max-w-sm md:basis-2/5">
                    <div class="max-w-sm bg-white rounded-lg shadow-lg drop-shadow-md">
                        <div class="px-6 py-4 max-w-80 max-h-72">
                            <img class="object-cover rounded-md w-80 h-72" src="{{ asset('images/avatar/'.$data->foto) }}" alt="" />
                        </div>
                        <div class="p-6">
                ...
                <div class="flex flex-col gap-3 md:basis-1/2">
                    <div class="block bg-white rounded-lg md:p-6">
                        ...
                        <div class="flex justify-between flex-none gap-4 py-3">
                            ...
                            <p class="text-sm">{{ date('d F Y', strtotime($data->tgl_lahir)) }} <a href="#" class="ml-2 text-cyan-500">Ubah</a></p>
                        </div>
                        <div class="flex justify-between flex-none gap-4 py-3">
                            <p class="text-sm text-gray-700">Jenis Kelamin</p>
                            <p class="text-sm">{{ $data->gender }}  <a href="#" class="ml-2 text-cyan-500">Ubah</a></p>
                        </div>
                    </div>
                    <div class="block bg-white rounded-lg md:p-6">
                        ...
                        <div class="flex justify-between flex-none gap-4 py-3">
                            ...
                            <p class="text-sm">{{ $data->contact }}  <a href="#" class="ml-2 text-cyan-500">Ubah</a></p>
                        </div>
                    </div>
                    <div class="block bg-white rounded-lg md:p-6">
                        ...
                        <div class="flex justify-between flex-none gap-4 py-3">
                            ...
                            <p class="text-sm">{{ $data->alamat }}  <a href="#" class="ml-2 text-cyan-500">Ubah</a></p>
                        </div>
                        <div class="flex justify-between flex-none gap-4 py-3">
                            <p class="text-sm text-gray-700">COD</p>
                            <p class="text-sm">{{ $data->cod }}  <a href="#" class="ml-2 text-cyan-500">Ubah</a></p>
                        </div>
                    </div>
