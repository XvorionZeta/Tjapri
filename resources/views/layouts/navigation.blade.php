<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <!-- Settings Dropdown -->
            <div class="hidden sm:flex sm:items-center sm:m-6 sm:justify-between gap-3">
                {{-- Message --}}
                ...
                @if (Auth::user() == null)
                        {{-- Login Button --}}
                        <div class="border-l-2 pl-2 border-slate-300 hidden sm:flex sm:items-center sm:m-6 sm:justify-between gap-2">
                            <a href="{{ route('login') }}">
                                <button
                                    data-mdb-ripple="true" data-mdb-ripple-color="light"
                                    class="inline-block px-6 py-2.5 bg-blue-600 brightness-125 text-blue-50 font-bold text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">
                                    Masuk
                                </button>
                            </a>
