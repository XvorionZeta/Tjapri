<form method="post" action="" enctype="multipart/form-data">
    ...
    @csrf
    {{-- 1. Modal Update Pcht --}}
    <div x-show="editProduct" x-transition.opacity x-transition:leave.delay.300ms
        class="fixed inset-0 z-[2000] flex flex-col items-center justify-center bg-black/50">
        <div x-show="editProduct" x-transition.duration.350ms @click.away="editProduct = false"
            @keyup.escape="editProduct = false"
            ...
            <div class="mt-7 flex justify-end gap-4">
                {{-- 3. Close Button --}}
                <button @click.prevent="editProduct = false" data-mdb-ripple="true" data-mdb-ripple-color="light"
